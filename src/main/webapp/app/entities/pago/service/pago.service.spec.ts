...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../pago.test-samples';

import { PagoService, RestPago } from './pago.service';

const requireRestSample: RestPago = {
  ...sampleWithRequiredData,
  fechaPago: sampleWithRequiredData.fechaPago?.toJSON(),
};
