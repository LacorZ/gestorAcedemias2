...
import com.rts.gestor.academia.domain.Course;
import com.rts.gestor.academia.repository.CourseRepository;
...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).price(DEFAULT_PRICE).duration(DEFAULT_DURATION);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).duration(UPDATED_DURATION);
        return course;
    }
    ...
    void createCourse() throws Exception {
        ...
        assertThat(testCourse.getPrice()).isEqualByComparingTo(DEFAULT_PRICE);
    ...
    void putExistingCourse() throws Exception {
        ...
        updatedCourse.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).duration(UPDATED_DURATION);
        ...
        assertThat(testCourse.getPrice()).isEqualByComparingTo(UPDATED_PRICE);
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.price(UPDATED_PRICE);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).duration(UPDATED_DURATION);
