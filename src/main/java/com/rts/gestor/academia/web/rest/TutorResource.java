    ...
    public ResponseEntity<Tutor> partialUpdateTutor(
        ...
        Optional<Tutor> result = tutorRepository
            ...
            .map(existingTutor -> {
                ...
                if (tutor.getDescription() != null) {
                    existingTutor.setDescription(tutor.getDescription());
                }
                if (tutor.getPhoto() != null) {
                    existingTutor.setPhoto(tutor.getPhoto());
                }
                if (tutor.getPhotoContentType() != null) {
                    existingTutor.setPhotoContentType(tutor.getPhotoContentType());
                }
