...
import { EntityArrayResponseType, EstudianteService } from '../service/estudiante.service';
...
export class EstudianteComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEstudiante): number => this.estudianteService.getEstudianteIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.estudiantes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IEstudiante[] | null): IEstudiante[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.estudianteService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
