...
describe('Pago Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pago', component: PagoComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to pagoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPagoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPagoIdentifier).toHaveBeenCalledWith(entity);
