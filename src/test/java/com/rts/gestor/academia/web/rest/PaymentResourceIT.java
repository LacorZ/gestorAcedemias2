...
import com.rts.gestor.academia.domain.Payment;
import com.rts.gestor.academia.repository.PaymentRepository;
...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().amount(DEFAULT_AMOUNT).paidAt(DEFAULT_PAID_AT);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().amount(UPDATED_AMOUNT).paidAt(UPDATED_PAID_AT);
        return payment;
    }
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.amount(UPDATED_AMOUNT).paidAt(UPDATED_PAID_AT);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.paidAt(UPDATED_PAID_AT);
