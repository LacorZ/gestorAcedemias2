...
import { EntityArrayResponseType, CursoService } from '../service/curso.service';
...
export class CursoComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICurso): number => this.cursoService.getCursoIdentifier(item);
